/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 780a5137b4fa1d1a37f80925e8476649)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "HOURLY_RETENTION_DAYS" | "PBKDF2_ITERATIONS">> {}
}
declare module "*.html" {
	const value: string;
